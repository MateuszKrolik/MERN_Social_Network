  ...
  useEffect(() => {
      ...
      try {
        const res = await axios.get(
          'https://mern-social-network-416113.ey.r.appspot.com/auth/status'
        );
    ...
    const loadPosts = async () => {
      try {
        const res = await axios.get(
          'https://mern-social-network-416113.ey.r.appspot.com/feed/posts?page=' +
            postPage
        );
    ...
    socket.current = openSocket(
      'https://mern-social-network-416113.ey.r.appspot.com'
    );
